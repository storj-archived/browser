		...
		<div class="card card-top-flat border-0 p-4 p-lg-5">
			<div class="div-responsive" v-cloak @drop.prevent="upload" @dragover.prevent>
				...
				<div class="row mb-2">
					...
					<div class="col-sm-12 col-md-4 col-xl-2 mb-3">
						<button class="btn btn-light btn-block" v-on:click="toggleFolderCreationInput" style="margin-right: 15px">
				...
				<div>
					<table class="table table-hover">
						...
						<tbody>
							...
							<tr v-if="this.$store.state.files.createFolderInputShow === true">
								<td span="3">

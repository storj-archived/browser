				...
				>
					<div class="row mb-2">
						...
						<div class="col-sm-12 col-md-4 col-xl-2 mb-3">
							...
							>
							<svg width="17" height="16" viewBox="0 0 17 16" fill="none" class="mr-2" xmlns="http://www.w3.org/2000/svg">
								<path d="M0.912109 1.92481C0.912109 1.1558 1.56545 0.5 2.41211 0.5H7.41211C7.70648 0.5 7.91211 0.724912 7.91211 0.962406C7.91211 1.78796 8.60191 2.42481 9.41211 2.42481H14.4121C15.2588 2.42481 15.9121 3.08061 15.9121 3.84962V14.0752C15.9121 14.8442 15.2588 15.5 14.4121 15.5H2.41211C1.56545 15.5 0.912109 14.8442 0.912109 14.0752V1.92481Z" fill="#768394" stroke="#7C8794"/>
					...
					<div v-if="displayUpload" v-on:click="buttonUpload" class="upload-help">
						<svg width="300" height="172" viewBox="0 0 300 172" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<p class="drop-files-text mt-4 mb-0">Drop Files Here to Upload</p>
					</div>
				</div>
			<file-modal
